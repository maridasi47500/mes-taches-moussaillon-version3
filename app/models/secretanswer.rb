class Secretanswer < ApplicationRecord
belongs_to :question,class_name:'Secretquestion', foreign_key: "question_id",optional: true
attr_accessor :u
attr_accessor :m
attr_accessor :noq
...
Secretquestion.find(i).secretanswers.joins(:question).select('secretanswers.text, secretanswers.id, secretquestions.typeq as qtype')
end
