...
layout false,only:[:people]
  ...
  def peoplearecoders
@coders=Programminglanguage.mycodersbypage(params[:page])
  end
...
def json
h=Programminglanguage.findbyname(params[:name])
render json: h
end
  def index
  ...
  def create
    ...
    respond_to do |format|
      if @programminglanguage.save
        format.html { redirect_to @programminglanguage, notice: "Programminglanguage was successfully created." }
  ...
  def update
    respond_to do |format|
      if @programminglanguage.update(programminglanguage_params)
        format.html { redirect_to @programminglanguage, notice: "Programminglanguage was successfully updated." }
  ...
  private
    ...
    def programminglanguage_params
      params.require(:programminglanguage).permit(:name, :image, :description,:coder_ids=>[])
    end
end
