...
class LanguagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create language" do
    assert_difference('Language.count') do
      post languages_url, params: { language: { image: @language.image, name: @language.name } }
    end
  ...
  test "should update language" do
    patch language_url(@language), params: { language: { image: @language.image, name: @language.name } }
