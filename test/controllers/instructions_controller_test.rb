...
class InstructionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create instruction" do
    assert_difference('Instruction.count') do
      post instructions_url, params: { instruction: { content_de: @instruction.content_de, content_en: @instruction.content_en, content_fr: @instruction.content_fr, otherinstruction_id: @instruction.otherinstruction_id } }
    end
  ...
  test "should update instruction" do
    patch instruction_url(@instruction), params: { instruction: { content_de: @instruction.content_de, content_en: @instruction.content_en, content_fr: @instruction.content_fr, otherinstruction_id: @instruction.otherinstruction_id } }
