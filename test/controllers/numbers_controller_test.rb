...
class NumbersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create number" do
    assert_difference('Number.count') do
      post numbers_url, params: { number: { description: @number.description, mytype: @number.mytype, myunit: @number.myunit, myvalue: @number.myvalue } }
    end
  ...
  test "should update number" do
    patch number_url(@number), params: { number: { description: @number.description, mytype: @number.mytype, myunit: @number.myunit, myvalue: @number.myvalue } }
