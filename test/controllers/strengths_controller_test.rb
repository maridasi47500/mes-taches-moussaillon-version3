...
class StrengthsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create strength" do
    assert_difference('Strength.count') do
      post strengths_url, params: { strength: { name_de: @strength.name_de, name_en: @strength.name_en, name_fr: @strength.name_fr } }
    end
  ...
  test "should update strength" do
    patch strength_url(@strength), params: { strength: { name_de: @strength.name_de, name_en: @strength.name_en, name_fr: @strength.name_fr } }
