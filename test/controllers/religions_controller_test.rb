...
class ReligionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create religion" do
    assert_difference('Religion.count') do
      post religions_url, params: { religion: { image: @religion.image, name: @religion.name } }
    end
  ...
  test "should update religion" do
    patch religion_url(@religion), params: { religion: { image: @religion.image, name: @religion.name } }
