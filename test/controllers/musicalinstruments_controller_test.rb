...
class MusicalinstrumentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create musicalinstrument" do
    assert_difference('Musicalinstrument.count') do
      post musicalinstruments_url, params: { musicalinstrument: { description: @musicalinstrument.description, image: @musicalinstrument.image, name: @musicalinstrument.name } }
    end
  ...
  test "should update musicalinstrument" do
    patch musicalinstrument_url(@musicalinstrument), params: { musicalinstrument: { description: @musicalinstrument.description, image: @musicalinstrument.image, name: @musicalinstrument.name } }
