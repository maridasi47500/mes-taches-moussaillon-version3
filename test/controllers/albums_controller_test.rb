...
class AlbumsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create album" do
    assert_difference('Album.count') do
      post albums_url, params: { album: { person_id: @album.person_id, title: @album.title } }
    end
  ...
  test "should update album" do
    patch album_url(@album), params: { album: { person_id: @album.person_id, title: @album.title } }
