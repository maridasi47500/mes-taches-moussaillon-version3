...
class ArgentsControllerTest < ActionDispatch::IntegrationTest
  setup do
    @argent = argents(:one)
  end
  ...
  test "should create argent" do
    assert_difference('Argent.count') do
      post argents_url, params: { argent: { annee: @argent.annee, apayer: @argent.apayer, mois: @argent.mois, paye: @argent.paye, username: @argent.username } }
    end
  ...
  test "should destroy argent" do
    ...
    assert_redirected_to argents_url
  end
end
