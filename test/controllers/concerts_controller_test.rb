...
class ConcertsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create concert" do
    assert_difference('Concert.count') do
      post concerts_url, params: { concert: { description: @concert.description, end_at: @concert.end_at, name_de: @concert.name_de, name_en: @concert.name_en, name_fr: @concert.name_fr, start_at: @concert.start_at } }
    end
  ...
  test "should update concert" do
    patch concert_url(@concert), params: { concert: { description: @concert.description, end_at: @concert.end_at, name_de: @concert.name_de, name_en: @concert.name_en, name_fr: @concert.name_fr, start_at: @concert.start_at } }
