...
class VideogamesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create videogame" do
    assert_difference('Videogame.count') do
      post videogames_url, params: { videogame: { image: @videogame.image, name: @videogame.name } }
    end
  ...
  test "should update videogame" do
    patch videogame_url(@videogame), params: { videogame: { image: @videogame.image, name: @videogame.name } }
