...
class PhilosophersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create philosopher" do
    assert_difference('Philosopher.count') do
      post philosophers_url, params: { philosopher: { image: @philosopher.image, name: @philosopher.name } }
    end
  ...
  test "should update philosopher" do
    patch philosopher_url(@philosopher), params: { philosopher: { image: @philosopher.image, name: @philosopher.name } }
