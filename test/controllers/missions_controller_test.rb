...
class MissionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mission" do
    assert_difference('Mission.count') do
      post missions_url, params: { mission: { name_de: @mission.name_de, name_en: @mission.name_en, name_fr: @mission.name_fr } }
    end
  ...
  test "should update mission" do
    patch mission_url(@mission), params: { mission: { name_de: @mission.name_de, name_en: @mission.name_en, name_fr: @mission.name_fr } }
