...
class GradesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create grade" do
    assert_difference('Grade.count') do
      post grades_url, params: { grade: { name_de: @grade.name_de, name_en: @grade.name_en, name_fr: @grade.name_fr } }
    end
  ...
  test "should update grade" do
    patch grade_url(@grade), params: { grade: { name_de: @grade.name_de, name_en: @grade.name_en, name_fr: @grade.name_fr } }
