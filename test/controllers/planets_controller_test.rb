...
class PlanetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create planet" do
    assert_difference('Planet.count') do
      post planets_url, params: { planet: { content: @planet.content, image: @planet.image, name: @planet.name } }
    end
  ...
  test "should update planet" do
    patch planet_url(@planet), params: { planet: { content: @planet.content, image: @planet.image, name: @planet.name } }
