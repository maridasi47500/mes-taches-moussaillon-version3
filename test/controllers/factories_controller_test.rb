...
class FactoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create factory" do
    assert_difference('Factory.count') do
      post factories_url, params: { factory: { image: @factory.image, name_de: @factory.name_de, name_en: @factory.name_en, name_fr: @factory.name_fr } }
    end
  ...
  test "should update factory" do
    patch factory_url(@factory), params: { factory: { image: @factory.image, name_de: @factory.name_de, name_en: @factory.name_en, name_fr: @factory.name_fr } }
