...
class BadgesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create badge" do
    assert_difference('Badge.count') do
      post badges_url, params: { badge: { description: @badge.description, image: @badge.image, name_de: @badge.name_de, name_en: @badge.name_en, name_fr: @badge.name_fr } }
    end
  ...
  test "should update badge" do
    patch badge_url(@badge), params: { badge: { description: @badge.description, image: @badge.image, name_de: @badge.name_de, name_en: @badge.name_en, name_fr: @badge.name_fr } }
