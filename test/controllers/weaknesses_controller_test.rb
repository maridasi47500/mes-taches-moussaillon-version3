...
class WeaknessesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create weakness" do
    assert_difference('Weakness.count') do
      post weaknesses_url, params: { weakness: { name_de: @weakness.name_de, name_en: @weakness.name_en, name_fr: @weakness.name_fr } }
    end
  ...
  test "should update weakness" do
    patch weakness_url(@weakness), params: { weakness: { name_de: @weakness.name_de, name_en: @weakness.name_en, name_fr: @weakness.name_fr } }
