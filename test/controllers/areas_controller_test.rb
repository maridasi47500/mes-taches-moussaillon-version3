...
class AreasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create area" do
    assert_difference('Area.count') do
      post areas_url, params: { area: { city_id: @area.city_id, name_de: @area.name_de, name_en: @area.name_en, name_fr: @area.name_fr } }
    end
  ...
  test "should update area" do
    patch area_url(@area), params: { area: { city_id: @area.city_id, name_de: @area.name_de, name_en: @area.name_en, name_fr: @area.name_fr } }
