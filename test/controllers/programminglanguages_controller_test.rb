...
class ProgramminglanguagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create programminglanguage" do
    assert_difference('Programminglanguage.count') do
      post programminglanguages_url, params: { programminglanguage: { description: @programminglanguage.description, image: @programminglanguage.image, name: @programminglanguage.name } }
    end
  ...
  test "should update programminglanguage" do
    patch programminglanguage_url(@programminglanguage), params: { programminglanguage: { description: @programminglanguage.description, image: @programminglanguage.image, name: @programminglanguage.name } }
