...
class DrinksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create drink" do
    assert_difference('Drink.count') do
      post drinks_url, params: { drink: { image: @drink.image, name_de: @drink.name_de, name_en: @drink.name_en, name_fr: @drink.name_fr } }
    end
  ...
  test "should update drink" do
    patch drink_url(@drink), params: { drink: { image: @drink.image, name_de: @drink.name_de, name_en: @drink.name_en, name_fr: @drink.name_fr } }
