...
class NewspapersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create newspaper" do
    assert_difference('Newspaper.count') do
      post newspapers_url, params: { newspaper: { name_de: @newspaper.name_de, name_en: @newspaper.name_en, name_fr: @newspaper.name_fr } }
    end
  ...
  test "should update newspaper" do
    patch newspaper_url(@newspaper), params: { newspaper: { name_de: @newspaper.name_de, name_en: @newspaper.name_en, name_fr: @newspaper.name_fr } }
