...
class NationalitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create nationality" do
    assert_difference('Nationality.count') do
      post nationalities_url, params: { nationality: { : @nationality., name_de: @nationality.name_de, name_en: @nationality.name_en } }
    end
  ...
  test "should update nationality" do
    patch nationality_url(@nationality), params: { nationality: { : @nationality., name_de: @nationality.name_de, name_en: @nationality.name_en } }
