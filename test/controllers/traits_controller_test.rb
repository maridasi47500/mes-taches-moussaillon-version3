...
class TraitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create trait" do
    assert_difference('Trait.count') do
      post traits_url, params: { trait: { name_de: @trait.name_de, name_en: @trait.name_en, name_fr: @trait.name_fr } }
    end
  ...
  test "should update trait" do
    patch trait_url(@trait), params: { trait: { name_de: @trait.name_de, name_en: @trait.name_en, name_fr: @trait.name_fr } }
