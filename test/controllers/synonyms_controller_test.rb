...
class SynonymsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create synonym" do
    assert_difference('Synonym.count') do
      post synonyms_url, params: { synonym: { content: @synonym.content, synonym_id: @synonym.synonym_id } }
    end
  ...
  test "should update synonym" do
    patch synonym_url(@synonym), params: { synonym: { content: @synonym.content, synonym_id: @synonym.synonym_id } }
