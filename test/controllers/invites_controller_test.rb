...
class InvitesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create invite" do
    assert_difference('Invite.count') do
      post invites_url, params: { invite: { image: @invite.image, namegroup: @invite.namegroup, vipassname: @invite.vipassname } }
    end
  ...
  test "should update invite" do
    patch invite_url(@invite), params: { invite: { image: @invite.image, namegroup: @invite.namegroup, vipassname: @invite.vipassname } }
