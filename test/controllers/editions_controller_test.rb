...
class EditionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create edition" do
    assert_difference('Edition.count') do
      post editions_url, params: { edition: { city: @edition.city, closed: @edition.closed, competition: @edition.competition, country: @edition.country, opened: @edition.opened, year: @edition.year } }
    end
  ...
  test "should update edition" do
    patch edition_url(@edition), params: { edition: { city: @edition.city, closed: @edition.closed, competition: @edition.competition, country: @edition.country, opened: @edition.opened, year: @edition.year } }
