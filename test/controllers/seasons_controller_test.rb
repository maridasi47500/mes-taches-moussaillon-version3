...
class SeasonsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create season" do
    assert_difference('Season.count') do
      post seasons_url, params: { season: { begin_at: @season.begin_at, end_at: @season.end_at, image: @season.image, name: @season.name } }
    end
  ...
  test "should update season" do
    patch season_url(@season), params: { season: { begin_at: @season.begin_at, end_at: @season.end_at, image: @season.image, name: @season.name } }
