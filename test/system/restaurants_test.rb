...
class RestaurantsTest < ApplicationSystemTestCase
  ...
  test "creating a Restaurant" do
    ...
    fill_in "City", with: @restaurant.city_id
    fill_in "Country", with: @restaurant.country_id
    ...
    fill_in "Place", with: @restaurant.place_id
    fill_in "State", with: @restaurant.state_id
